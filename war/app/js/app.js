...
mexGED.run(["$log", function($log) {
	
	$log.log('I\'m a line from custom.js');
	
}]);

mexGED.config(["RouteHelpersProvider", function(RouteHelpersProvider) {
...
mexGED.service('services', ["$log", "$rootScope", "$http", "$q", "toaster", function($log, $rootScope, $http, $q, toaster) {
	var factory = {};
	var userInfo;
	var currentProcess;
	var currentFlow;
